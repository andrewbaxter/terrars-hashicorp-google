...
impl NetworkConnectivityHub {
    ...
    pub fn routing_vpcs(&self) -> ListRef<NetworkConnectivityHubRoutingVpcsElRef> {
        ListRef::new(self.shared().clone(), format!("{}.routing_vpcs", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> NetworkConnectivityHubTimeoutsElRef {
        NetworkConnectivityHubTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
pub struct BuildNetworkConnectivityHub {
    pub tf_id: String,
    #[doc= "Immutable. The name of the hub. Hub names must be unique. They use the following form: `projects/{project_number}/locations/global/hubs/{hub_id}`"]
...
impl BuildNetworkConnectivityHubRoutingVpcsEl {
    pub fn build(self) -> NetworkConnectivityHubRoutingVpcsEl {
        NetworkConnectivityHubRoutingVpcsEl { uri: core::default::Default::default() }
    }
}
