...
impl IapBrand {
    ...
    pub fn application_title(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.application_title", self.extract_ref()))
    }
    ...
    pub fn org_internal_only(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.org_internal_only", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> IapBrandTimeoutsElRef {
        IapBrandTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
