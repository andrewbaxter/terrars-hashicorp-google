...
impl ContainerRegistry {
    ...
    #[doc= "Get a reference to the value of field `bucket_self_link` after provisioning.\nThe URI of the created resource."]
    pub fn bucket_self_link(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.bucket_self_link", self.extract_ref()))
    }
...
impl Referable for ContainerRegistry {
...
impl Resource_ for ContainerRegistry_ {
    fn extract_resource_type(&self) -> String {
        "google_container_registry".into()
    }
