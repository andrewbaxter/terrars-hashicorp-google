...
#[derive(Serialize)]
struct DataplexZoneIamPolicyData {
...
struct DataplexZoneIamPolicy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataplexZoneIamPolicyData>,
}

#[derive(Clone)]
pub struct DataplexZoneIamPolicy(Rc<DataplexZoneIamPolicy_>);

impl DataplexZoneIamPolicy {
...
impl Referable for DataplexZoneIamPolicy {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for DataplexZoneIamPolicy { }

impl ToListMappable for DataplexZoneIamPolicy {
    type O = ListRef<DataplexZoneIamPolicyRef>;
...
impl Resource_ for DataplexZoneIamPolicy_ {
...
pub struct BuildDataplexZoneIamPolicy {
    pub tf_id: String,
    #[doc= ""]
...
impl BuildDataplexZoneIamPolicy {
    pub fn build(self, stack: &mut Stack) -> DataplexZoneIamPolicy {
        let out = DataplexZoneIamPolicy(Rc::new(DataplexZoneIamPolicy_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataplexZoneIamPolicyData {
...
pub struct DataplexZoneIamPolicyRef {
    shared: StackShared,
    base: String,
}

impl Ref for DataplexZoneIamPolicyRef {
