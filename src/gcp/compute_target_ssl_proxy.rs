...
#[derive(Serialize)]
struct ComputeTargetSslProxyData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<ComputeTargetSslProxyTimeoutsEl>,
}

struct ComputeTargetSslProxy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ComputeTargetSslProxyData>,
}

#[derive(Clone)]
pub struct ComputeTargetSslProxy(Rc<ComputeTargetSslProxy_>);

impl ComputeTargetSslProxy {
    ...
    pub fn set_timeouts(self, v: impl Into<ComputeTargetSslProxyTimeoutsEl>) -> Self {
    ...
    pub fn timeouts(&self) -> ComputeTargetSslProxyTimeoutsElRef {
        ComputeTargetSslProxyTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}

impl Referable for ComputeTargetSslProxy {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ComputeTargetSslProxy { }

impl ToListMappable for ComputeTargetSslProxy {
    type O = ListRef<ComputeTargetSslProxyRef>;
...
impl Resource_ for ComputeTargetSslProxy_ {
    fn extract_resource_type(&self) -> String {
        "google_compute_target_ssl_proxy".into()
    }
...
pub struct BuildComputeTargetSslProxy {
    pub tf_id: String,
...
impl BuildComputeTargetSslProxy {
    pub fn build(self, stack: &mut Stack) -> ComputeTargetSslProxy {
        let out = ComputeTargetSslProxy(Rc::new(ComputeTargetSslProxy_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ComputeTargetSslProxyData {
...
pub struct ComputeTargetSslProxyRef {
    shared: StackShared,
    base: String,
}

impl Ref for ComputeTargetSslProxyRef {
...
#[derive(Serialize)]
pub struct ComputeTargetSslProxyTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ComputeTargetSslProxyTimeoutsEl {
...
impl ToListMappable for ComputeTargetSslProxyTimeoutsEl {
    type O = BlockAssignable<ComputeTargetSslProxyTimeoutsEl>;
...
pub struct BuildComputeTargetSslProxyTimeoutsEl {}

impl BuildComputeTargetSslProxyTimeoutsEl {
    pub fn build(self) -> ComputeTargetSslProxyTimeoutsEl {
        ComputeTargetSslProxyTimeoutsEl {
...
pub struct ComputeTargetSslProxyTimeoutsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for ComputeTargetSslProxyTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> ComputeTargetSslProxyTimeoutsElRef {
        ComputeTargetSslProxyTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl ComputeTargetSslProxyTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
