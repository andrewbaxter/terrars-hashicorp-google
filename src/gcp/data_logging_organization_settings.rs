...
#[derive(Serialize)]
struct DataLoggingOrganizationSettingsData {
...
struct DataLoggingOrganizationSettings_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataLoggingOrganizationSettingsData>,
}

#[derive(Clone)]
pub struct DataLoggingOrganizationSettings(Rc<DataLoggingOrganizationSettings_>);

impl DataLoggingOrganizationSettings {
...
impl Referable for DataLoggingOrganizationSettings {
    fn extract_ref(&self) -> String {
        format!("data.{}.{}", self.0.extract_datasource_type(), self.0.extract_tf_id())
    }
}

impl Datasource for DataLoggingOrganizationSettings { }

impl ToListMappable for DataLoggingOrganizationSettings {
    type O = ListRef<DataLoggingOrganizationSettingsRef>;
...
impl Datasource_ for DataLoggingOrganizationSettings_ {
...
pub struct BuildDataLoggingOrganizationSettings {
    pub tf_id: String,
    #[doc= "The organization for which to retrieve settings."]
    pub organization: PrimField<String>,
}

impl BuildDataLoggingOrganizationSettings {
    pub fn build(self, stack: &mut Stack) -> DataLoggingOrganizationSettings {
        let out = DataLoggingOrganizationSettings(Rc::new(DataLoggingOrganizationSettings_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataLoggingOrganizationSettingsData {
...
pub struct DataLoggingOrganizationSettingsRef {
    shared: StackShared,
    base: String,
}

impl Ref for DataLoggingOrganizationSettingsRef {
...
impl DataLoggingOrganizationSettingsRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
